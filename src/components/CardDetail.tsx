...
import { downloadFile, getWhatsAppUrl } from '../lib/vcard'
            ...
            <FieldRow key={`phone-${i}`} label={i === 0 ? t('field.phone') : ''} value={p}>
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-[#25D366] hover:bg-[#1da851] transition-colors flex-shrink-0"
